<mxfile host="app.diagrams.net" modified="2023-03-03T14:34:45.736Z" agent="5.0 (Windows)" etag="7i03gcZtKdTMjXljc-Gq" version="20.8.22" type="github">
  <diagram name="Page-1" id="IUxOKu0dbIdwTakqLazK">
    <mxGraphModel dx="393" dy="640" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="850" pageHeight="1100" math="0" shadow="0">
      <root>
        ...
        <mxCell id="2rxak70cD-DugquTEaYe-2" value="Item 1" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;rotatable=0;whiteSpace=wrap;html=1;" vertex="1" parent="2rxak70cD-DugquTEaYe-1">
          <mxGeometry y="30" width="140" height="30" as="geometry" />
        </mxCell>
        <mxCell id="2rxak70cD-DugquTEaYe-3" value="Item 2" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;rotatable=0;whiteSpace=wrap;html=1;" vertex="1" parent="2rxak70cD-DugquTEaYe-1">
        ...
        <mxCell id="2rxak70cD-DugquTEaYe-5" value="CodeDeck" style="swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=30;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;whiteSpace=wrap;html=1;" vertex="1" parent="1">
          <mxGeometry x="410" y="210" width="140" height="120" as="geometry" />
        </mxCell>
        <mxCell id="2rxak70cD-DugquTEaYe-6" value="Item 1" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;rotatable=0;whiteSpace=wrap;html=1;" vertex="1" parent="2rxak70cD-DugquTEaYe-5">
          <mxGeometry y="30" width="140" height="30" as="geometry" />
        </mxCell>
